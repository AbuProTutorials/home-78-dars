...
function InputOtp_ng_container_0_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("value", ctx_r2.getModelValue(i_r2))("maxLength", 1)("type", ctx_r2.inputType)("inputmode", ctx_r2.inputMode)("variant", ctx_r2.variant)("readonly", ctx_r2.readonly)("disabled", ctx_r2.disabled)("invalid", ctx_r2.invalid)("tabindex", ctx_r2.tabindex)("unstyled", ctx_r2.unstyled);
  }
}
...
var InputOtp = class _InputOtp {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    dependencies: [NgForOf, NgIf, NgTemplateOutlet, InputText],
    encapsulation: 2,
    changeDetection: 0
  });
};
